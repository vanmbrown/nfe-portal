...
export const bodyElixirData: ProductData = {
  ...
  ingredients: [
    {
      ...
      benefits: ['Barrier comfort', 'Moisture retention', 'Skin conditioning'],
      source: 'Synthetic',
      safety: 'safe',
    },
    {
      ...
      benefits: ['Antioxidant support', 'Cushioned skin feel', 'Non-comedogenic'],
    ...
    },
    {
      ...
      benefits: ['Comfort-focused', 'Soothing feel', 'Skin conditioning'],
    ...
    },
    {
      ...
      benefits: ['Comfort support', 'Visible aging support', 'Skin conditioning'],
  ...
  benefits: [
    {
      title: 'Barrier Comfort & Conditioning',
      description: 'Ceramide complex supports barrier comfort and moisture retention, essential for melanated skin prone to dryness.',
      timeline: '2-4 weeks',
    },
    {
    ...
    {
      title: 'Comfort-Focused & Soothing',
      description: 'Blue tansy and bisabolol help skin feel comforted and conditioned, especially when body skin feels dry or reactive.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Yes, the formula is designed for sensitive-feeling skin with comfort-focused ingredients like blue tansy and bisabolol.',
    },
    {
